...
$config['message_start_delimiter'] = '<small class="text-success">'; 	// Message start delimiter
$config['message_end_delimiter']   = '</small>'; 	// Message end delimiter
$config['error_start_delimiter']   = '<small class="text-danger">';		// Error message start delimiter
$config['error_end_delimiter']     = '</small>';	// Error message end delimiter
